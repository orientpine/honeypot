...
- `plugins/isd-generator/assets/output_templates/chapter2_content.md`: 출력 문서 기본 구조
- `plugins/isd-generator/assets/output_templates/chapter2_references.md`: 참고자료 템플릿
